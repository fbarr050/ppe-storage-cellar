...
class NuevoTrabajadorForm(QDialog):
    def __init__(self):
        super().__init__()
        ...
        self.rut_input.setText(str(self.get_rut()))
        ...
        self.cancel_button.clicked.connect(self.delete_row)
    #def enviar_sap(self):
    ...
    def get_rut(self):
        try:
            ...
            sentencia_sql = '''SELECT rut FROM trabajador WHERE nombre IS NULL'''
